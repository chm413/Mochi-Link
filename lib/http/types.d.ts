...
export interface CreateServerResponse extends APIResponse<{
    serverId: string;
    token: string;
}> {
}
...
export interface KickPlayerResponse extends APIResponse<{
    success: boolean;
}> {
}
...
export interface AddWhitelistResponse extends APIResponse<{
    success: boolean;
    cached?: boolean;
}> {
}
...
export interface RemoveWhitelistResponse extends APIResponse<{
    success: boolean;
    cached?: boolean;
}> {
}
...
export interface CreateBanResponse extends APIResponse<{
    banId: string;
}> {
}
...
export interface QuickActionResponse extends APIResponse<{
    success: boolean;
    result?: any;
}> {
}
...
export interface CreateBindingResponse extends APIResponse<{
    bindingId: number;
}> {
}
