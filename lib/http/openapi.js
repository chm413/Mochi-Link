...
exports.generateOpenApiYaml = generateOpenApiYaml;
exports.openApiSpec = {
    openapi: '3.0.3',
    info: {
...
function generateOpenApiSpec() {
    return JSON.stringify(exports.openApiSpec, null, 2);
}
/**
...
function generateOpenApiYaml() {
    ...
    const yamlLines = [];
    function addYamlLine(line, indent = 0) {
        yamlLines.push('  '.repeat(indent) + line);
    }
    addYamlLine('openapi: 3.0.3');
    addYamlLine('info:');
    addYamlLine(`title: "${exports.openApiSpec.info.title}"`, 1);
    addYamlLine(`description: "${exports.openApiSpec.info.description}"`, 1);
    addYamlLine(`version: "${exports.openApiSpec.info.version}"`, 1);
    addYamlLine('servers:');
    exports.openApiSpec.servers?.forEach(server => {
