...
exports.ProtocolHandler = exports.ProtocolHandlerLogger = void 0;
/**
 * Protocol Handler Configuration and Logger
 */
class ProtocolHandlerLogger {
    constructor(ctx) {
...
exports.ProtocolHandlerLogger = ProtocolHandlerLogger;
/**
...
class ProtocolHandler {
    ...
    async handleResponse(response, connection) {
        ...
        if (response.op !== pendingRequest.operation) {
            pendingRequest.reject(new types_1.ProtocolError(`Response operation mismatch: expected ${pendingRequest.operation}, got ${response.op}`, response.requestId));
            return;
        }
    ...
    setupDefaultHandlers() {
        ...
        this.onSystem('capabilities', async (message, connection) => {
            ...
            connection.capabilities = (0, capabilities_1.normalizeConnectorCapabilities)(message.data?.capabilities);
        });
    }
    // ============================================================================
