...
exports.MessageUtils = exports.MessageFactory = exports.UWBP_COMPATIBLE_VERSIONS = exports.PROTOCOL_NAME = exports.UWBP_VERSION = void 0;
exports.isCompatibleUWBPVersion = isCompatibleUWBPVersion;
...
exports.UWBP_COMPATIBLE_VERSIONS = ['2.0', '2.0.0'];
function isCompatibleUWBPVersion(value) {
    return typeof value === 'string' && exports.UWBP_COMPATIBLE_VERSIONS.includes(value);
}
// ============================================================================
// Message Factories
// ============================================================================
class MessageFactory {
     ...
     */
    static createError(requestId, op, error, code = 'INTERNAL_ERROR', details) {
