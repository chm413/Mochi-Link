    ...
    async assignRole(userId, serverId, role, grantedBy, expiresAt) {
        try {
            ...
            if (granterRole !== 'owner') {
                throw new types_1.PermissionDeniedError('Only server owner can assign roles', grantedBy, serverId, 'permission.grant');
            }
    ...
    async removeRole(userId, serverId, removedBy) {
        try {
            ...
            if (removerRole !== 'owner') {
                throw new types_1.PermissionDeniedError('Only server owner can remove roles', removedBy, serverId, 'permission.revoke');
            }
    ...
    async updateRole(userId, serverId, newRole, updatedBy, expiresAt, reason) {
        try {
            ...
            if (updaterRole !== 'owner') {
                throw new types_1.PermissionDeniedError('Only server owner can update roles', updatedBy, serverId, 'permission.update');
            }
