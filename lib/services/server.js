...
class ServerManager {
    ...
    async createWebSocketBridge(serverId, connection) {
        ...
        try {
            ...
            let bridge;
            const bridgeConfig = (0, bridge_1.createBridgeConfig)(server.id, server.coreType, server.coreName, server.coreVersion, server.connectionConfig);
            ...
            const sendRequestAndWait = async (op, data = {}, timeout = 30000) => {
                ...
                sendCommand: async (command, timeout) => {
                    ...
                    try {
                        ...
                        return {
                            ...
                            output,
                            executionTime: Number(response.executionTime
            ...
            bridge = (0, bridge_1.createConnectorBridge)(bridgeConfig, connectionAdapter);
