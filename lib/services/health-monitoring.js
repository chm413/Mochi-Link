...
class HealthMonitoringService extends events_1.EventEmitter {
    ...
    // ============================================================================
    startSystemChecks() {
        this.systemCheckInterval = setInterval(() => this.performSystemCheck(), this.config.systemCheckInterval).unref?.();
    }
    startServiceChecks() {
        this.serviceCheckInterval = setInterval(() => this.performServiceChecks(), this.config.serviceCheckInterval).unref?.();
    }
    startDeepChecks() {
        this.deepCheckInterval = setInterval(() => this.performDeepCheck(), this.config.deepCheckInterval).unref?.();
    }
