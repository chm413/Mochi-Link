...
class ReconnectionManager {
     ...
     * 构造函数
     */
    constructor(logger, config, callback) {
        // 重连状态
    ...
    scheduleReconnect() {
        ...
        this.logger.info(`调度第 ${this.currentAttempts} 次重连，${this.nextInterval} 毫秒后执行 (总尝试: ${this.totalAttempts})`);
     ...
     * 计算指数退避间隔
     */
    calculateBackoffInterval(attempts) {
