 ...
 * @version 2.1.0
 */
public class MochiLinkFoliaCommand implements CommandExecutor, TabCompleter {
    ...
    private void handleStatus(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.GOLD + "=== MochiLink Folia Status ===");
    ...
    private void handleInfo(CommandSender sender) {
        sender.sendMessage(ChatColor.GOLD + "=== MochiLink Folia Info ===");
        ...
        sender.sendMessage(ChatColor.YELLOW + "Server Type: " + ChatColor.WHITE + "Folia");
    ...
    private void handleReconnectionControl(CommandSender sender, String[] args) {
        ...
        if (args.length == 0) {
            ...
            sender.sendMessage(ChatColor.YELLOW + "Current Attempts: " + ChatColor.WHITE + status.currentAttempts);
            sender.sendMessage(ChatColor.YELLOW + "Total Attempts: " + ChatColor.WHITE + status.totalAttempts);
            sender.sendMessage(ChatColor.YELLOW + "Next Interval: " + ChatColor.WHITE + status.nextInterval + "ms");
            
            if (status.lastAttemptTime > 0) {
                sender.sendMessage(ChatColor.YELLOW + "Last Attempt: " + ChatColor.WHITE + 
                    new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(
                        new java.util.Date(status.lastAttemptTime)));
            }
    ...
    private void sendHelp(CommandSender sender) {
        sender.sendMessage(ChatColor.GOLD + "=== MochiLink Folia Commands ===");
