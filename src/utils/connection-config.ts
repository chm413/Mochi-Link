...
export function capabilitiesToMode(caps: WsCapabilities): 'forward' | 'reverse' {
...
export function parseConnectionConfig(server: any): Record<string, any> {
...
export function normalizeServerConnectionConfig(
...
export function resolveServerWsCapabilities(server: any): WsCapabilities {
